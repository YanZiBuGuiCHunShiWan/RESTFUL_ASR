...
paramerr4="Parameter 'filename' should end with *.wav ."
    ...
    def post(self):
        ...
        try:
            ...
            if data.get('filename'):
                ...
                assert  filename.endswith(".wav") or filename.endswith(".mp3"),paramerr4
                pass
            else:
            ...
            if mode=="true":
                result["text"]=convert2base64(text.encode("utf-8"))
            else:
                result["text"]=text
